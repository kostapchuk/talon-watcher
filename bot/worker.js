...
const HOW_TO_ADD = [
  "<code>/add ссылка на врача</code> — следить за ним",
  "",
  "Формат ссылки:",
  `<code>${EXAMPLE_URL}</code>`,
  "",
  "Как найти: открой <a href=\"https://talon.by/services\">Платные услуги</a>, " +
    "найди врача и скопируй ссылку на него.",
  "",
  "Можно дописать название через пробел — <code>/add ссылка гинеколог</code>.",
  "",
  "И команда не обязательна: пришли просто ссылку, хоть с названием, " +
